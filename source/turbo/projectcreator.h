...
public:
    ...
    static void createSDLFrameBuffer() noexcept
    {
        // Create directories
        createDir("bin");
        createDir("build");
        ...
        createFile(".gitignore", gitignoreContent());
        createFile("Makefile", makefileContentSDL());
        createFile("src/main.c", mainContentSDLFrameBuffer());
        createFile("src/universal_renderer.h", universalRendererContent());
        createFile("src/core/array_t/array_t.h", arrayTContent());
    }
private:
...
int main(void)
{
    ...
    static std::string mainContentSDLFrameBuffer() noexcept
    {
        return R"(#define SDL_MAIN_USE_CALLBACKS 1  /* use the callbacks instead of main() */
#include <SDL3/SDL.h>
#include <SDL3/SDL_main.h>
...
SDL_AppResult SDL_AppIterate(void *appstate)
{
    ...
    static std::string universalRendererContent() noexcept
    {
        return R"(#ifndef __UNIVERSAL_RENDERER_H__
...
#define FPS_HISTORY 10
    ...
    static std::string arrayTContent() noexcept
    {
        return R"(#ifndef __ARRAY_T_H__
